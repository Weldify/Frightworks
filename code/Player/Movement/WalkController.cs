...
public partial class WalkController : MoveController
{
	...
	public override void Simulate()
	{
		...
		WishVelocity = new Vector3( Input.AnalogMove.x.Clamp( -1f, 1f ), Input.AnalogMove.y.Clamp( -1f, 1f ), 0 );
	...
	{
		var wishvel = new Vector3( Input.AnalogMove.x.Clamp( -1f, 1f ), Input.AnalogMove.y.Clamp( -1f, 1f ), 0 );
